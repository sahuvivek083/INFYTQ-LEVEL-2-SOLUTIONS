"""
Write a recursive python function which returns True if the input is well-formatted with respect
to the list labels. Else it should return False.
...
def check_well_formatted(input_item, list_label):
    ...
    list_label1=['VP', 'V']
    result=check_well_formatted(input_item,list_label1)
